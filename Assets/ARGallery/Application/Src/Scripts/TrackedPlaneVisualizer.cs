...
namespace GoogleARCore.HelloAR
{
    ...
    public class TrackedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void Awake()
        {
			...
			boxCollider = GetComponent<UnityEngine.BoxCollider>();
        }
        ...
        public void Initialize(TrackedPlane plane)
        {
			...
			m_MeshRenderer.material.SetColor("_GridColor", new Color(1f, 1f, 1f));
        ...
        private void _UpdateMeshIfNeeded()
        {
			...
			boxCollider.center = m_PlaneCenter;
...
//			for (var i=0;i<m_MeshVertices.Count;i++)
//			{
...
//
		...
		{
			float alpha = m_MeshRenderer.material.color.a;
